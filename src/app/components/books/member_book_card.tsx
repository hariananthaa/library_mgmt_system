...
function MemberBookCard({ book }: { book: Book }) {
  return (
    <div
      key={book.id}
      className="h-full w-full rounded-md bg-white p-4 flex flex-col justify-between shadow border border-t-gray-100"
    >
      ...
      <div className="flex w-full items-center justify-between pt-2 border-t">
        <div className=" space-y-[2px]">
          <p className="text-sm text-start">{book.genre}</p>
